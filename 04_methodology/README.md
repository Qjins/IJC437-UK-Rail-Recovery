...
2. **Cleaning and validation** — robust rail-year parsing, handling of ORR footnote markers (`[b]` series break, `[x]`/`[z]` missing), programmatic completeness checks (11 regions × 30 years).
