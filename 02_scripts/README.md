...
| Script | Purpose |
|---|---|
| `01_data_cleaning.R` | Parses the raw ORR ODS tables (regional, national, station), handles footnote markers (`[b]`, `[x]`, `[z]`), extracts rail years robustly and validates completeness (11 regions x 30 years, no missing values). |
